        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-truck me-2"></i>LogistokQ</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="index.php?url=dtkurir" class="nav-item nav-link"><i class="fa-solid fa-person-biking me-2"></i>Kurir</a>
                    <a href="index.php?url=dtUser" class="nav-item nav-link"><i class="fa fa-user me-2"></i>Akun</a>
                </div>
            </nav>
        </div>